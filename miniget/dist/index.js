...
const streamModule = require('stream').Stream
const httpLibs = { 'http:': http.default, 'https:': https.default };
...
function Miniget(url, options = {}) {
    ...
    const stream = streamModule.PassThrough({ highWaterMark: opts.highWaterMark });
