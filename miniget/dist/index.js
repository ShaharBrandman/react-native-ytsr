    ...
    return {
        on: (event, callback) => {
            switch (event) {
                ...
                default:
                    console.warn(`react-native-ytsr: miniget: unknown event listener received: ${event}`)
            }
        },
        setEncoding: () => {
            console.warn(`react-native-ytsr: miniget: will not use specified encoding since request has already been made. Currently using utf8 encoding.`)
        },
        text: () => {
